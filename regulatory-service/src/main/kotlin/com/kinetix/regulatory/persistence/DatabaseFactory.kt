...
data class DatabaseConfig(
    ...
    val username: String,
    val password: String,
    val poolConfig: ConnectionPoolConfig = ConnectionPoolConfig.forService("regulatory-service"),
)
...
object DatabaseFactory {
    ...
    const val FLYWAY_LOCATION = "classpath:db/regulatory"
    ...
    private fun runMigrations(dataSource: HikariDataSource) {
        Flyway.configure()
            ...
            .locations("classpath:db/regulatory")
            .load()
            .migrate()
    }
}
