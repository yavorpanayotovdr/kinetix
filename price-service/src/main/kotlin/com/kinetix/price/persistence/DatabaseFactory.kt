...
data class DatabaseConfig(
    ...
    val poolConfig: ConnectionPoolConfig = ConnectionPoolConfig.forService("price-service"),
)
...
object DatabaseFactory {
    ...
    const val FLYWAY_LOCATION = "classpath:db/price"
