...
data class DatabaseConfig(
    ...
    val poolConfig: ConnectionPoolConfig = ConnectionPoolConfig.forService("reference-data-service"),
)
...
object DatabaseFactory {
    ...
    const val FLYWAY_LOCATION = "classpath:db/referencedata"
    ...
    private fun runMigrations(dataSource: HikariDataSource) {
        Flyway.configure()
            ...
            .locations("classpath:db/referencedata")
            .load()
            .migrate()
    }
}
