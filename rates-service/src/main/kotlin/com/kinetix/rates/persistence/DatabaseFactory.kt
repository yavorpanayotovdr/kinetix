...
data class DatabaseConfig(
    ...
    val poolConfig: ConnectionPoolConfig = ConnectionPoolConfig.forService("rates-service"),
)
...
object DatabaseFactory {
    ...
    const val FLYWAY_LOCATION = "classpath:db/rates"
