...
data class DatabaseConfig(
    ...
    val poolConfig: ConnectionPoolConfig = ConnectionPoolConfig.forService("volatility-service"),
)
...
object DatabaseFactory {
    ...
    const val FLYWAY_LOCATION = "classpath:db/volatility"
    ...
    private fun runMigrations(dataSource: HikariDataSource) {
        Flyway.configure()
            ...
            .locations("classpath:db/volatility")
            .load()
            .migrate()
    }
}
